...
(function () {
  var S = {
    ...
    ja: {
      ct_tag: '資料',
      ct_title: '助数詞',
      ct_desc: '日本語では、数えるものの形に合わせて助数詞を選び、前につく数もそれに合わせて音が変わります。下のどの助数詞も1から10まで示し、音が変わる読みを金色で示しています。',
      ct_guide_h: '📐 早わかり',
      ct_g1_h: '日本語には数え方が二通りある',
      ct_g1_p: '一つは和語の系列 — <span class="jp">ひとつ、ふたつ、みっつ</span> — で、10までならほとんどのものに使えます。もう一つは漢語の系列で、数のうしろにものに合った助数詞がつきます：鉛筆2本なら <span class="jp">二本</span>、紙2枚なら <span class="jp">二枚</span>。',
      ct_g2_h: '音が変わる。そこが学びどころ',
      ct_g2_p: '<span class="jp">いちほん</span> とは言えません。<span class="jp">いっぽん</span> になります。h- で始まる助数詞は1・6・8・10のあとで p- に、3のあとで b- に変わります。k-・s-・t- で始まる助数詞は1・8・10のあとで子音が重なります。',
      ct_g3_h: '「いくつ」とたずねる',
      ct_g3_p: '数の位置に <span class="jp">何</span> を置きます：<span class="jp">何本</span>・<span class="jp">何枚</span>・<span class="jp">何人</span>。音の変わり方は3と同じで、なんほん ではなく <span class="jp">なんぼん</span> です。',
      ct_legend: '凡例',
      ct_legend_irr: 'ここで読みが変わります — 覚えるところ',
      ct_legend_reg: '規則的：数 + もとの読み',
      ct_legend_ask: 'いくつ — 何〜',
      ct_pick_h: '何を数えるか選んでください',
      ct_count: '助数詞 {n} 件',
      ct_how_many: 'いくつ',
      ct_listen: '🔊 1〜10 を聞く',
      ct_stop: '■ 停止',
      ct_ref_badge: '資料',
      ct_ref_h: 'ひと目でわかる一覧',
      ct_ref_sub: '同じ読みを表にしたものです。学ぶためというより、さっと調べるためのものです。金色のマスが音の変わる読みです。行をクリックすると、その助数詞が上に開きます。',
      ct_col_counter: '助数詞'
    }
  };
  for (var lang in S) {
