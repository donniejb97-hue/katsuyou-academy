...
var I18N = {
  ...
  de: {
    ...
    howto_kit_1:"<b>So fängst du an:</b> Leg einfach los. Tippe ein, was das Kanji bedeutet, und drück <b>Enter</b>. Du weißt es nicht? Drück <b>Antwort zeigen</b> — du siehst Bedeutung, Lesungen und ein Beispielwort, und es kostet dich nichts: kein Fehler, deine Serie bleibt, die Wand ändert sich nicht. Mit <b>Enter</b> geht’s zum nächsten, und weiter so.",
    howto_kit_2:"<b>Richtig oder falsch?</b> Die Karte leuchtet grün auf, wenn du richtig liegst, und rot, wenn nicht. Bei einem knappen Tippfehler bekommst du noch einen Versuch; Plural und Klammerteile im Schlüsselwort sind egal. Wiederholst du einen Block, den du kennst? Das <b>⚙ Zahnrad</b> am Ende der Punkteleiste kann nach einer richtigen Antwort direkt zum nächsten Kanji springen.",
  ...
  zh: {
    ...
    howto_kit_1:"<b>从这里开始：</b>直接开始就好。输入这个汉字的意思，按 <b>Enter</b>。不知道？点<b>显示答案</b>——你会看到字义、读音和一个例词，而且没有任何代价：不算答错，连对不断，字墙也不变。再按 <b>Enter</b> 进入下一个，继续练。",
    howto_kit_2:"<b>对还是错？</b>答对时字卡亮起绿色边框，答错时是红色。拼写只差一点会再给你一次机会；关键词的复数和括号里的部分都不影响。复习已经会的一组？得分栏末尾的<b>⚙ 齿轮</b>可以设置答对后直接进入下一个字。",
  ...
  ja: {
    ...
    howto_kit_1:"<b>はじめかた：</b>とにかく始めてみましょう。漢字の意味を入力して <b>Enter</b>。わからなければ<b>答えを見る</b>——意味・読み・例語が表示され、何のマイナスもありません：不正解にならず、連続正解も途切れず、壁も変わりません。<b>Enter</b> で次へ進み、どんどん続けましょう。",
    howto_kit_2:"<b>正解？不正解？</b>正解ならカードが緑の枠で、不正解なら赤い枠で光ります。つづりが惜しいときはもう一度チャンスがあります。キーワードの複数形やかっこ内の部分は気にしなくて大丈夫です。覚えたブロックの復習なら、スコア欄の端にある<b>⚙ 歯車</b>で、正解したらすぐ次の字へ進むように設定できます。",
