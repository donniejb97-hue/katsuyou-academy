...
var I18N = {
  en: {
    ...
    demo_tab_talk:"Talk",
    demo_kana_hint:"Click the card to reveal the reading.",
    demo_next:"Next character",
    demo_check:"Check",
  ...
  de: {
    ...
    demo_kana_hint:"Auf die Karte klicken, um die Lesung zu sehen.",
    demo_next:"Nächstes Zeichen",
    demo_check:"Prüfen",
  ...
  fr: {
    ...
    demo_kana_hint:"Cliquez sur la carte pour afficher la lecture.",
    demo_next:"Caractère suivant",
    demo_check:"Vérifier",
