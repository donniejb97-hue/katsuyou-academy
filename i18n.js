...
var I18N = {
  en: {
    ...
    howto_shift_1:"<b>Start here:</b> just begin. Type the answer and press <b>Enter</b>. For Japanese answers, type rōmaji and it turns into kana as you go. Stuck? <b>Show me</b> gives you the answer — it counts as a miss, so the word comes back sooner.",
    ...
    howto_shift_4:"<b>The tray:</b> every question drops a can — <b>blue</b> = right · <b>red</b> = wrong · <b>dashed</b> = skipped. <b>Skip</b> counts for nothing either way. Ten cans make a round.",
  ...
  de: {
    ...
    howto_shift_1:"<b>So fängst du an:</b> Leg einfach los. Tippe die Antwort und drück <b>Enter</b>. Bei japanischen Antworten tippst du Rōmaji, und es wird beim Tippen zu Kana. Keine Ahnung? <b>Zeig mir</b> verrät die Antwort — das zählt als Fehler, also kommt das Wort früher wieder.",
    ...
    howto_shift_4:"<b>Das Fach:</b> Jede Frage lässt eine Dose fallen — <b>blau</b> = richtig · <b>rot</b> = falsch · <b>gestrichelt</b> = übersprungen. <b>Überspringen</b> zählt weder so noch so. Zehn Dosen sind eine Runde.",
  ...
  fr: {
    ...
    howto_shift_1:"<b>Pour commencer :</b> lancez-vous. Tapez la réponse et appuyez sur <b>Entrée</b>. Pour les réponses en japonais, tapez en rōmaji : ça se change en kana au fil de la frappe. Bloqué ? <b>Montre-moi</b> donne la réponse — ça compte comme une erreur, donc le mot revient plus tôt.",
    ...
    howto_shift_4:"<b>Le bac :</b> chaque question fait tomber une canette — <b>bleu</b> = juste · <b>rouge</b> = faux · <b>pointillés</b> = passée. <b>Passer</b> ne compte ni pour ni contre. Dix canettes font une manche.",
  ...
  zh: {
    ...
    howto_shift_1:"<b>从这里开始：</b>直接开始。输入答案并按 <b>Enter</b>。日语答案可以输入罗马字，会边打边变成假名。卡住了？<b>给我看</b>会显示答案——这算答错，所以这个词会更早再出现。",
    ...
    howto_shift_4:"<b>取物口：</b>每道题掉下一罐——<b>蓝色</b> = 对 · <b>红色</b> = 错 · <b>虚线</b> = 跳过。<b>跳过</b>不算对也不算错。十罐为一轮。",
  ...
  ja: {
    ...
    howto_shift_1:"<b>まずはここから：</b>とにかく始めましょう。答えを入力して <b>Enter</b>。日本語の答えはローマ字で打つと、打ちながらかなに変わります。わからない？<b>答えを見る</b>で答えが出ます——間違い扱いになるので、その単語は早めにまた出てきます。",
    ...
    howto_shift_4:"<b>取り出し口：</b>問題ごとに缶がひとつ落ちます——<b>青</b> = 正解 · <b>赤</b> = 不正解 · <b>点線</b> = とばした。<b>とばす</b>はどちらにも数えません。缶十本で一ラウンドです。",
