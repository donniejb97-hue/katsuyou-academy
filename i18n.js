...
var I18N = {
  en: {
    ...
    vq_to_cards:"← Back to the Word Book", nav_kanji:'The WoK', nav_contact:'Contact',
  ...
  de: {
    ...
    vq_to_cards:"← Zurück zum Wörterbuch", nav_kanji:'The WoK', nav_contact:'Kontakt',
  ...
  fr: {
    ...
    vq_to_cards:"← Retour au carnet de mots", nav_kanji:'The WoK', nav_contact:'Contact',
  ...
  zh: {
    ...
    kd_set_say:"朗读读音",
    kd_flash:"✓ 答对了——下一个…",
    vq_to_cards:"← 返回单词本", nav_kanji:'The WoK', nav_contact:'联系',
  ...
  ja: {
    ...
    kd_set_say:"読みを読み上げる",
    kd_flash:"✓ 正解——次へ…",
    vq_to_cards:"← 単語帳に戻る", nav_kanji:'The WoK', nav_contact:'お問い合わせ',
