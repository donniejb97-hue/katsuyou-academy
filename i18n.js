...
var I18N = {
  en: {
    ...
    check:'Check Answer', next:'Next Question →', skip:'Show me the answer (no penalty)', reset:'↺ Reset Score',
    ...
    toolkit_sub:"Nine interconnected tools covering the foundations of Japanese",
    // ---- kanji drill ----
    ...
    // ---- homepage ----
    hero_desc:"A free Japanese learning platform. Learn and drill kana, kanji, vocabulary and verb conjugation, then put it to use in conversation — all in one place.",
  ...
  de: {
    ...
    check:'Antwort prüfen', next:'Nächste Frage →', skip:'Antwort zeigen (ohne Abzug)', reset:'↺ Punkte zurücksetzen',
    ...
    toolkit_sub:"Neun miteinander verbundene Werkzeuge für die Grundlagen des Japanischen",
    ...
    // ---- homepage ----
    hero_desc:"Eine kostenlose Lernplattform für Japanisch. Lernen und üben Sie Kana, Kanji, Wortschatz und Verbkonjugation — und wenden Sie alles danach im Gespräch an.",
  ...
  fr: {
    ...
    check:'Vérifier', next:'Question suivante →', skip:'Voir la réponse (sans pénalité)', reset:'↺ Réinitialiser le score',
    ...
    toolkit_sub:"Neuf outils complémentaires couvrant les bases du japonais",
    ...
    // ---- homepage ----
    hero_desc:"Une plateforme gratuite pour apprendre le japonais. Apprenez et travaillez les kana, les kanji, le vocabulaire et la conjugaison, puis mettez le tout en pratique en conversation.",
  ...
  zh: {
    ...
    placeholder:'输入罗马音…',
    check:'检查答案', next:'下一题 →', skip:'显示答案（不扣分）', reset:'↺ 重置得分',
    ...
    // ---- homepage ----
    hero_desc:"免费的日语学习平台。学习并操练假名、汉字、词汇与动词变位，再在对话中真正用起来——全都在一个地方。",
