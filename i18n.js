...
var I18N = {
  en: {
    ...
    opt_type_quiz:'Include "what type is this verb?" questions',
    badge_review:'\ud83d\udd01 Review \u2014 you missed this one before',
    badge_type_quiz:'\ud83e\udded Verb-type question',
    goal_10:'Round of 10', goal_20:'Round of 20', goal_50:'Round of 50', goal_none:'No limit',
    kbd_hint:'Press <kbd>Enter</kbd> to check, then <kbd>Enter</kbd> again for the next question.',
    ...
    conj_info_rows:[
      ...
      ['Alt+I / Esc','Open or close this box.'],
  ...
  de: {
    ...
    opt_type_quiz:'Fragen nach dem Verbtyp einbeziehen',
    badge_review:'\ud83d\udd01 Wiederholung \u2014 das ging vorhin daneben',
    badge_type_quiz:'\ud83e\udded Frage zum Verbtyp',
    goal_10:'Runde mit 10', goal_20:'Runde mit 20', goal_50:'Runde mit 50', goal_none:'Ohne Limit',
    kbd_hint:'<kbd>Enter</kbd> prüft die Antwort, noch einmal <kbd>Enter</kbd> bringt die nächste Frage.',
    ...
    conj_info_rows:[
      ...
      ['Alt+I / Esc','Dieses Fenster öffnen oder schließen.'],
  ...
  fr: {
    ...
    opt_type_quiz:'Inclure les questions sur le type de verbe',
    badge_review:'\ud83d\udd01 Révision \u2014 vous vous étiez trompé ici',
    badge_type_quiz:'\ud83e\udded Question sur le type de verbe',
    goal_10:'Manche de 10', goal_20:'Manche de 20', goal_50:'Manche de 50', goal_none:'Sans limite',
    kbd_hint:'<kbd>Entrée</kbd> pour vérifier, puis <kbd>Entrée</kbd> à nouveau pour la question suivante.',
    ...
    conj_info_rows:[
      ...
      ['Alt+I / Échap','Ouvrir ou fermer cette fenêtre.'],
  ...
  zh: {
    ...
    opt_type_quiz:'包含「这是哪类动词？」的题目',
    badge_review:'\ud83d\udd01 复习 \u2014 这道题您之前答错过',
    badge_type_quiz:'\ud83e\udded 动词类型题',
    goal_10:'一轮 10 题', goal_20:'一轮 20 题', goal_50:'一轮 50 题', goal_none:'不限题数',
    kbd_hint:'按 <kbd>Enter</kbd> 检查答案，再按一次 <kbd>Enter</kbd> 进入下一题。',
