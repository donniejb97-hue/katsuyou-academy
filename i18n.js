...
var I18N = {
  en: {
    ...
    howto_wok_1:"<b>Every kanji is a stamp on the wall</b> — all 2,300 from the Kodansha Kanji Learner’s Course, in course order, in blocks of 100. Pick a block along the strip.",
    howto_wok_2:"<b>Three looks.</b> <span class=\"howto-sw is-new\"></span> blank = not met yet · <span class=\"howto-sw is-shaky\"></span> red outline = shaky (you missed it) · <span class=\"howto-sw is-solid\"></span> colour = solid. The <b>Colours</b> button chooses how solid stamps are coloured.",
    howto_wok_3:"<b>Tap a stamp</b> to open its card: keyword, readings, example words, and a Listen button. It also shows how often you got it right and wrong.",
    howto_wok_4:"<b>One at a time</b> flips through the same block as flashcards, if you would rather read than scan.",
    howto_wok_5:"<b>Drill</b> sends the block — or only your shaky ones — to the Kanji Kitchen in rounds of ten.",
    howto_wok_6:"<b>How stamps change:</b> a right answer in the Kitchen makes a new kanji solid at once. Miss one and it turns shaky; two right in a row win it back.",
    howto_wok_7:"Progress lives in this browser only — nothing to sign up for, nothing leaves your device.",
    howto_kit_title:"Kanji Kitchen",
    howto_kit_1:"<b>Choose what to cook:</b> a range of 500 from the menu, or come from the wall with a block or just your shaky kanji. Either way you get <b>rounds of ten</b>.",
    howto_kit_2:"<b>Two directions:</b> see the kanji and give its keyword, or see the keyword and give the kanji.",
    howto_kit_3:"<b>Type it or Pick it.</b> Typing is stricter but sticks better; Pick it offers four choices. Small spelling differences are forgiven.",
    howto_kit_4:"<b>Skip</b> is free — the kanji is neither right nor wrong. <b>Show me the answer</b> counts as a miss, so use it when you are stuck, not curious.",
    howto_kit_5:"<b>Katsu</b> pops in after six misses in a row to help; the gear turns that off.",
    howto_kit_6:"<b>Score:</b> Right, Wrong, Streak and Best are for this visit. What you missed this round is listed under the card, newest first.",
    howto_kit_7:"Every answer is stamped on <b>The WoK</b>: right once makes a fresh kanji solid, a miss turns it shaky, two right in a row win it back.",
  ...
  de: {
    ...
    howto_wok_title:"The WoK",
    howto_wok_1:"<b>Jedes Kanji ist ein Stempel an der Wand</b> — alle 2.300 aus dem Kodansha Kanji Learner’s Course, in Kursreihenfolge, in Blöcken zu 100. Wähle einen Block in der Leiste.",
    howto_wok_2:"<b>Drei Zustände.</b> <span class=\"howto-sw is-new\"></span> leer = noch nicht gesehen · <span class=\"howto-sw is-shaky\"></span> roter Rand = wackelig (du hast es verfehlt) · <span class=\"howto-sw is-solid\"></span> Farbe = sicher. Mit <b>Colours</b> wählst du, wie sichere Stempel gefärbt werden.",
    howto_wok_3:"<b>Tippe auf einen Stempel</b> und seine Karte öffnet sich: Stichwort, Lesungen, Beispielwörter und ein Anhören-Knopf. Dazu, wie oft du richtig und falsch lagst.",
    howto_wok_4:"<b>One at a time</b> blättert denselben Block als Karteikarten durch, wenn du lieber liest als überfliegst.",
    howto_wok_5:"<b>Drill</b> schickt den Block — oder nur deine wackeligen — in Zehnerrunden in die Kanji Kitchen.",
    howto_wok_6:"<b>So ändern sich Stempel:</b> eine richtige Antwort in der Kitchen macht ein neues Kanji sofort sicher. Verfehlst du eins, wird es wackelig; zweimal richtig hintereinander holt es zurück.",
    howto_wok_7:"Der Fortschritt bleibt in diesem Browser — kein Konto, nichts verlässt dein Gerät.",
    howto_kit_title:"Kanji Kitchen",
    howto_kit_1:"<b>Wähle, was gekocht wird:</b> einen 500er-Bereich aus dem Menü, oder komm von der Wand mit einem Block oder nur deinen wackeligen Kanji. So oder so gibt es <b>Zehnerrunden</b>.",
    howto_kit_2:"<b>Zwei Richtungen:</b> Kanji sehen und das Stichwort nennen, oder Stichwort sehen und das Kanji nennen.",
    howto_kit_3:"<b>Type it oder Pick it.</b> Tippen ist strenger, bleibt aber besser hängen; Pick it bietet vier Antworten. Kleine Schreibunterschiede werden verziehen.",
    howto_kit_4:"<b>Skip</b> kostet nichts — das Kanji zählt weder richtig noch falsch. <b>Antwort zeigen</b> zählt als Fehler, also nur, wenn du feststeckst.",
    howto_kit_5:"<b>Katsu</b> meldet sich nach sechs Fehlern in Folge; das Zahnrad schaltet das ab.",
    howto_kit_6:"<b>Punkte:</b> Richtig, Falsch, Serie und Bestwert gelten für diesen Besuch. Was du diese Runde verfehlt hast, steht unter der Karte, neuestes zuerst.",
    howto_kit_7:"Jede Antwort wird an <b>The WoK</b> gestempelt: einmal richtig macht ein neues Kanji sicher, ein Fehler macht es wackelig, zweimal richtig holt es zurück.",
  ...
  fr: {
    ...
    howto_wok_title:"The WoK",
    howto_wok_1:"<b>Chaque kanji est un tampon sur le mur</b> — les 2 300 du Kodansha Kanji Learner’s Course, dans l’ordre du cours, par blocs de 100. Choisis un bloc dans la bande.",
    howto_wok_2:"<b>Trois aspects.</b> <span class=\"howto-sw is-new\"></span> vide = pas encore vu · <span class=\"howto-sw is-shaky\"></span> contour rouge = fragile (raté) · <span class=\"howto-sw is-solid\"></span> couleur = acquis. Le bouton <b>Colours</b> choisit la couleur des tampons acquis.",
    howto_wok_3:"<b>Touche un tampon</b> pour ouvrir sa fiche : mot-clé, lectures, exemples et un bouton Écouter. Elle indique aussi tes bonnes et mauvaises réponses.",
    howto_wok_4:"<b>One at a time</b> fait défiler le même bloc en cartes, si tu préfères lire que balayer.",
    howto_wok_5:"<b>Drill</b> envoie le bloc — ou seulement tes fragiles — à la Kanji Kitchen par manches de dix.",
    howto_wok_6:"<b>Comment les tampons changent :</b> une bonne réponse dans la Kitchen rend un nouveau kanji acquis d’emblée. Rate-le et il devient fragile ; deux bonnes réponses d’affilée le rattrapent.",
    howto_wok_7:"Ta progression reste dans ce navigateur — pas de compte, rien ne quitte ton appareil.",
    howto_kit_title:"Kanji Kitchen",
    howto_kit_1:"<b>Choisis quoi cuisiner :</b> une tranche de 500 dans le menu, ou viens du mur avec un bloc ou seulement tes kanji fragiles. Dans les deux cas, des <b>manches de dix</b>.",
    howto_kit_2:"<b>Deux sens :</b> voir le kanji et donner son mot-clé, ou voir le mot-clé et donner le kanji.",
    howto_kit_3:"<b>Type it ou Pick it.</b> Taper est plus strict mais s’ancre mieux ; Pick it propose quatre choix. Les petites fautes d’orthographe sont pardonnées.",
    howto_kit_4:"<b>Skip</b> est gratuit — ni juste ni faux. <b>Voir la réponse</b> compte comme une erreur : à utiliser quand tu bloques, pas par curiosité.",
    howto_kit_5:"<b>Katsu</b> apparaît après six erreurs d’affilée pour t’aider ; l’engrenage le désactive.",
    howto_kit_6:"<b>Score :</b> Justes, Fausses, Série et Record valent pour cette visite. Ce que tu as raté cette manche s’affiche sous la carte, le plus récent en premier.",
    howto_kit_7:"Chaque réponse est tamponnée sur <b>The WoK</b> : une bonne réponse rend un nouveau kanji acquis, une erreur le rend fragile, deux bonnes d’affilée le rattrapent.",
  ...
  zh: {
    ...
    howto_toggle:"收起 / 展开",
    howto_wok_title:"The WoK",
    howto_wok_1:"<b>每个汉字都是墙上的一枚印章</b>——讲谈社《Kanji Learner’s Course》全部 2,300 字，按课程顺序，每 100 字一组。在横条上选一组。",
    howto_wok_2:"<b>三种状态。</b><span class=\"howto-sw is-new\"></span> 空白 = 还没见过 · <span class=\"howto-sw is-shaky\"></span> 红框 = 不稳（答错过）· <span class=\"howto-sw is-solid\"></span> 有色 = 掌握。<b>Colours</b> 按钮决定掌握印章的配色。",
    howto_wok_3:"<b>点一枚印章</b>打开它的卡片：关键词、读音、例词和朗读按钮，还有你答对、答错的次数。",
    howto_wok_4:"<b>One at a time</b> 把同一组按单词卡逐个翻看，适合细读而非浏览。",
    howto_wok_5:"<b>Drill</b> 把这一组——或只把不稳的字——送进 Kanji Kitchen，每轮十题。",
    howto_wok_6:"<b>印章怎么变：</b>在 Kitchen 答对一次，新字立刻变为掌握；答错一次变为不稳，连续答对两次才能夺回。",
    howto_wok_7:"进度只保存在这个浏览器里——无需注册，数据不会离开你的设备。",
    howto_kit_title:"Kanji Kitchen",
    howto_kit_1:"<b>选择要练的内容：</b>从菜单里选一个 500 字的范围，或从墙上带来一组、或只带不稳的字。无论哪种，都是<b>每轮十题</b>。",
    howto_kit_2:"<b>两个方向：</b>看汉字答关键词，或看关键词答汉字。",
    howto_kit_3:"<b>Type it 或 Pick it。</b>打字更严格但记得更牢；Pick it 给出四个选项。轻微的拼写差异会被宽容。",
    howto_kit_4:"<b>Skip</b> 不计分——既不算对也不算错。<b>查看答案</b>算答错，所以卡住时再用，别出于好奇。",
    howto_kit_5:"连续答错六题后 <b>Katsu</b> 会出来帮忙；齿轮里可以关掉。",
    howto_kit_6:"<b>计分：</b>正确、错误、连对和最佳只算本次访问。本轮答错的字列在卡片下方，最新的在前。",
    howto_kit_7:"每次作答都会盖在 <b>The WoK</b> 上：新字答对一次即掌握，答错一次变不稳，连对两次夺回。",
  ...
  ja: {
    ...
    howto_toggle:"巻く / 開く",
    howto_wok_title:"The WoK",
    howto_wok_1:"<b>漢字は一字ずつ壁のスタンプ</b> — 講談社 Kanji Learner’s Course の2,300字を、コース順に100字ずつ。帯からブロックを選びます。",
    howto_wok_2:"<b>三つの見た目。</b><span class=\"howto-sw is-new\"></span> 白 = まだ見ていない · <span class=\"howto-sw is-shaky\"></span> 赤枠 = 不安定（間違えた）· <span class=\"howto-sw is-solid\"></span> 色つき = 定着。<b>Colours</b> で定着スタンプの色の付け方を選べます。",
    howto_wok_3:"<b>スタンプをタップ</b>するとカードが開きます：キーワード、読み、例語、聞くボタン。正解・不正解の回数も出ます。",
    howto_wok_4:"<b>One at a time</b> は同じブロックを単語カードのように一枚ずつめくります。",
    howto_wok_5:"<b>Drill</b> はそのブロック — または不安定な字だけ — を10問ずつ Kanji Kitchen に送ります。",
    howto_wok_6:"<b>スタンプの変わり方：</b>Kitchen で一度正解すれば新しい字はすぐ定着。間違えると不安定になり、二連続正解で取り戻せます。",
    howto_wok_7:"進み具合はこのブラウザにだけ保存されます。登録不要、データは端末の外に出ません。",
    howto_kit_title:"Kanji Kitchen",
    howto_kit_1:"<b>何を練習するか選ぶ：</b>メニューから500字の範囲を選ぶか、壁からブロックや不安定な字だけを持ってきます。どちらも<b>10問ずつ</b>です。",
    howto_kit_2:"<b>二つの方向：</b>漢字を見てキーワードを答えるか、キーワードを見て漢字を答えるか。",
    howto_kit_3:"<b>Type it か Pick it。</b>入力は厳しめですがよく身につきます。Pick it は四択。細かな綴りの違いは大目に見ます。",
    howto_kit_4:"<b>Skip</b> は無料 — 正解でも不正解でもありません。<b>答えを見る</b>は不正解扱いなので、行き詰まったときだけ。",
    howto_kit_5:"六連続で間違えると <b>Katsu</b> が助けに来ます。歯車で切れます。",
    howto_kit_6:"<b>スコア：</b>正解・不正解・連続・最高は今回の分。このラウンドで間違えた字はカードの下に、新しい順に並びます。",
    howto_kit_7:"答えはすべて <b>The WoK</b> に押されます：新しい字は一度の正解で定着、一度の間違いで不安定、二連続正解で回復。",
