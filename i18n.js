...
var I18N = {
  en: {
    ...
    howto_wok_1:"<b>Start here:</b> pick a block of 100 on the strip (or press <b>Jump to where I left off</b>), open <b>Drill</b> and choose what to practise. The Kanji Kitchen quizzes you, and every answer comes back here as a stamp.",
    ...
    howto_wok_3:"<b>Tap any stamp</b> to open its card: the keyword (what it means), the on and kun readings, example words, how often you got it right and wrong, and speaker buttons to hear them.",
    howto_wok_4:"<b>On the card:</b> <b>Drill this one</b> practises just that kanji · <b>Mark as solid</b> if you already know it · <b>Look it up</b> opens the Dictionary. <b>← →</b> move to the next kanji, <b>Esc</b> closes.",
    howto_wok_5:"<b>Drill</b> has four choices: the block’s shaky kanji, the ones you haven’t started, the whole block, or every shaky kanji on the wall. A good habit: new ones first, then clear the shaky ones.",
    howto_wok_6:"<b>One at a time</b> shows the block as flashcards — a good first look before you drill it.",
    howto_wok_7:"<b>Search</b> finds a kanji by the character, its keyword or its KLC number: 日, “sun” or #330.",
    howto_wok_8:"<b>How stamps change:</b> right once in the Kitchen = solid · a miss = shaky · two right in a row = solid again. <b>Show me the answer</b> changes nothing. <b>Colours</b> only changes the look (Mosaic, Ink or Spectrum).",
    howto_wok_9:"Your progress is saved in this browser — no account needed, and nothing leaves your device.",
    ...
    howto_kit_2:"<b>Right or wrong?</b> The card lights up with a green outline when you’re right and a red one when you’re not. A near-miss spelling gets one more try; plurals and the bracketed bits of a keyword don’t matter.",
    howto_kit_3:"<b>What you’re drilling:</b> the menu on the right (KLC 1–500 and so on) picks kanji at random from that range. Sent here from the wall? Then you drill that block, or just your shaky ones, in <b>rounds of ten</b> — the pips in the score bar show how far you are.",
    ...
    howto_kit_6:"<b>Hear the readings</b> (top left of the card) reads the on and kun readings aloud. After you answer, the speaker buttons read the readings and the example word.",
  ...
  de: {
    ...
    howto_wok_title:"The WoK",
    howto_kit_title:"Kanji Kitchen",
    howto_wok_1:"<b>So fängst du an:</b> Wähle in der Leiste einen Block mit 100 Kanji (oder <b>Dort weitermachen, wo ich war</b>), öffne <b>Üben</b> und wähle, was du üben willst. Die Kanji Kitchen fragt dich ab, und jede Antwort landet hier als Stempel.",
    ...
    howto_wok_3:"<b>Tippe auf einen Stempel</b>, um seine Karte zu öffnen: das Schlüsselwort (die Bedeutung), On- und Kun-Lesungen, Beispielwörter, wie oft du richtig und falsch lagst, und Lautsprecher-Knöpfe zum Anhören.",
    howto_wok_4:"<b>Auf der Karte:</b> <b>Dieses üben</b> übt nur dieses Kanji · <b>Als sitzend markieren</b>, wenn du es schon kannst · <b>Nachschlagen</b> öffnet das Wörterbuch. <b>← →</b> zum nächsten Kanji, <b>Esc</b> schließt.",
    howto_wok_5:"<b>Üben</b> bietet vier Möglichkeiten: die wackeligen des Blocks, die noch nicht begonnenen, den ganzen Block oder alle wackeligen der Wand. Eine gute Gewohnheit: erst die neuen, dann die wackeligen abarbeiten.",
    howto_wok_6:"<b>Einzeln</b> zeigt den Block als Karteikarten — ein guter erster Blick, bevor du ihn übst.",
    howto_wok_7:"<b>Suche</b> findet ein Kanji über das Zeichen, sein Schlüsselwort oder seine KLC-Nummer: 日, „sun“ oder #330.",
    howto_wok_8:"<b>Wie sich Stempel ändern:</b> einmal richtig in der Kitchen = sitzt · falsch = wackelig · zweimal hintereinander richtig = sitzt wieder. <b>Antwort zeigen</b> ändert nichts. <b>Farben</b> ändert nur das Aussehen (Mosaik, Tinte oder Spektrum).",
    howto_wok_9:"Dein Fortschritt wird in diesem Browser gespeichert — kein Konto nötig, nichts verlässt dein Gerät.",
    ...
    howto_kit_2:"<b>Richtig oder falsch?</b> Die Karte leuchtet grün auf, wenn du richtig liegst, und rot, wenn nicht. Bei einem knappen Tippfehler bekommst du noch einen Versuch; Plural und Klammerteile im Schlüsselwort sind egal.",
    howto_kit_3:"<b>Was du übst:</b> Das Menü rechts (KLC 1–500 usw.) zieht Kanji zufällig aus diesem Bereich. Kommst du von der Wand? Dann übst du diesen Block oder nur deine wackeligen in <b>Zehnerrunden</b> — die Punkte in der Punkteleiste zeigen, wie weit du bist.",
    ...
    howto_kit_6:"<b>Lesungen anhören</b> (oben links auf der Karte) liest die On- und Kun-Lesungen vor. Nach der Antwort lesen die Lautsprecher-Knöpfe die Lesungen und das Beispielwort vor.",
  ...
  fr: {
    ...
    howto_wok_title:"The WoK",
    howto_kit_title:"Kanji Kitchen",
    howto_wok_1:"<b>Pour commencer :</b> choisis un bloc de 100 dans la bande (ou <b>Reprendre où j'en étais</b>), ouvre <b>S'exercer</b> et choisis quoi travailler. La Kanji Kitchen t’interroge, et chaque réponse revient ici sous forme de tampon.",
    ...
    howto_wok_3:"<b>Touche un tampon</b> pour ouvrir sa carte : le mot-clé (le sens), les lectures on et kun, des mots d’exemple, combien de fois tu as eu juste ou faux, et des boutons haut-parleur pour les écouter.",
    howto_wok_4:"<b>Sur la carte :</b> <b>Travailler celui-ci</b> s’exerce sur ce seul kanji · <b>Marquer comme acquis</b> si tu le connais déjà · <b>Chercher dans le dictionnaire</b> ouvre le dictionnaire. <b>← →</b> passent au kanji suivant, <b>Échap</b> ferme.",
    howto_wok_5:"<b>S'exercer</b> propose quatre choix : les fragiles du bloc, ceux pas commencés, tout le bloc, ou tous les fragiles du mur. Une bonne habitude : d’abord les nouveaux, puis les fragiles.",
    howto_wok_6:"<b>Un par un</b> montre le bloc en cartes — un bon premier regard avant de t’exercer.",
    howto_wok_7:"<b>La recherche</b> trouve un kanji par le caractère, son mot-clé ou son numéro KLC : 日, « sun » ou #330.",
    howto_wok_8:"<b>Comment les tampons changent :</b> juste une fois dans la Kitchen = acquis · une erreur = fragile · deux justes d’affilée = acquis à nouveau. <b>Voir la réponse</b> ne change rien. <b>Couleurs</b> ne change que l’apparence (Mosaïque, Encre ou Spectre).",
    howto_wok_9:"Ta progression est enregistrée dans ce navigateur — pas de compte, et rien ne quitte ton appareil.",
    ...
    howto_kit_2:"<b>Juste ou faux ?</b> La carte s’entoure de vert quand tu as juste et de rouge sinon. Une faute de frappe de peu te donne un second essai ; le pluriel et les parties entre crochets du mot-clé ne comptent pas.",
    howto_kit_3:"<b>Ce que tu travailles :</b> le menu à droite (KLC 1–500, etc.) tire des kanji au hasard dans cette plage. Venu du mur ? Alors tu travailles ce bloc, ou seulement tes fragiles, par <b>manches de dix</b> — les points de la barre de score montrent où tu en es.",
    ...
    howto_kit_6:"<b>Écouter les lectures</b> (en haut à gauche de la carte) lit à voix haute les lectures on et kun. Après ta réponse, les boutons haut-parleur lisent les lectures et le mot d’exemple.",
  ...
  zh: {
    ...
    howto_wok_title:"The WoK",
    howto_kit_title:"Kanji Kitchen",
    howto_wok_1:"<b>从这里开始：</b>在横条上选一组 100 个字（或点<b>跳到上次的位置</b>），打开<b>练习</b>，选择要练的内容。Kanji Kitchen 会考你，每个回答都会以印章的形式回到这里。",
    ...
    howto_wok_3:"<b>点任意一枚印章</b>打开字卡：关键词（字义）、音读和训读、例词、你答对和答错的次数，以及可以收听的喇叭按钮。",
    howto_wok_4:"<b>字卡上：</b><b>练习这个字</b>只练这一个 · 已经会了就点<b>标记为已掌握</b> · <b>在词典中查</b>打开词典。<b>← →</b>切换到下一个字，<b>Esc</b>关闭。",
    howto_wok_5:"<b>练习</b>有四个选项：本组不牢的字、还没开始的字、整组，或整面墙上所有不牢的字。好习惯：先练新字，再清掉不牢的。",
    howto_wok_6:"<b>逐个学</b>把这一组做成闪卡——练习之前先看一遍很合适。",
    howto_wok_7:"<b>搜索</b>可以按汉字本身、关键词或 KLC 编号查找：日、“sun”或 #330。",
    howto_wok_8:"<b>印章怎么变：</b>在 Kitchen 答对一次 = 已掌握 · 答错 = 不牢 · 连续答对两次 = 重新掌握。<b>显示答案</b>什么都不改变。<b>颜色</b>只改变外观（马赛克、墨色或光谱）。",
    howto_wok_9:"你的进度保存在这个浏览器里——不用注册，数据不会离开你的设备。",
    ...
    howto_kit_2:"<b>对还是错？</b>答对时字卡亮起绿色边框，答错时是红色。拼写只差一点会再给你一次机会；关键词的复数和括号里的部分都不影响。",
    howto_kit_3:"<b>练的是什么：</b>右边的菜单（KLC 1–500 等）从这个范围里随机抽字。从字墙过来的？那就是练那一组，或只练你不牢的字，每<b>十个一轮</b>——得分栏里的小点显示进度。",
    ...
    howto_kit_6:"<b>听读音</b>（字卡左上角）朗读音读和训读。回答之后，喇叭按钮会读出读音和例词。",
  ...
  ja: {
    ...
    howto_wok_title:"The WoK",
    howto_kit_title:"Kanji Kitchen",
    howto_wok_1:"<b>はじめかた：</b>帯から100字のブロックを選び（または<b>続きから始める</b>）、<b>練習</b>を開いて練習する内容を選びます。Kanji Kitchen で出題され、答えはすべてここにハンコとして戻ってきます。",
    ...
    howto_wok_3:"<b>ハンコをタップ</b>するとカードが開きます：キーワード（意味）、音読み・訓読み、例語、正解・不正解の回数、そして聞くためのスピーカーボタン。",
    howto_wok_4:"<b>カードでできること：</b><b>この字を練習</b>でその字だけを練習 · もう覚えているなら<b>定着にする</b> · <b>辞書で調べる</b>で辞書を開く。<b>← →</b>で次の字へ、<b>Esc</b>で閉じます。",
    howto_wok_5:"<b>練習</b>には4つの選択肢：ブロックのあやふやな字、まだ手をつけていない字、ブロック全部、壁のあやふやな字すべて。おすすめは、新しい字から始めて、あやふやな字を片づけること。",
    howto_wok_6:"<b>一枚ずつ</b>はブロックをフラッシュカードで見せます——練習の前にざっと見るのにぴったり。",
    howto_wok_7:"<b>検索</b>は字そのもの、キーワード、KLC 番号で探せます：日、sun、#330 など。",
    howto_wok_8:"<b>ハンコの変わりかた：</b>Kitchen で1回正解＝定着 · 間違い＝あやふや · 2回続けて正解＝また定着。<b>答えを見る</b>では何も変わりません。<b>色</b>は見た目だけを変えます（モザイク・墨・スペクトル）。",
    howto_wok_9:"進み具合はこのブラウザに保存されます——登録不要で、データが端末の外に出ることはありません。",
    ...
    howto_kit_2:"<b>正解？不正解？</b>正解ならカードが緑の枠で、不正解なら赤い枠で光ります。つづりが惜しいときはもう一度チャンスがあります。キーワードの複数形やかっこ内の部分は気にしなくて大丈夫です。",
    howto_kit_3:"<b>練習する範囲：</b>右のメニュー（KLC 1–500 など）がその範囲からランダムに出題します。壁から来た場合は、そのブロック、またはあやふやな字だけを<b>10問ずつのラウンド</b>で練習します——スコア欄の点が進み具合です。",
    ...
    howto_kit_6:"<b>読みを聞く</b>（カード左上）で音読み・訓読みを読み上げます。答えたあとは、スピーカーボタンで読みと例語を聞けます。",
