...
var I18N = {
  ...
  de: {
    nav_home:'Start', nav_kana:'Kana', nav_learn:'Lernen', nav_group_learn:'Lernen', nav_group_vocab:'Wörter', nav_group_practice:'Üben', nav_counters:'Zählwörter', nav_dictionary:'Wörterbuch', nav_deconjugator:'Dekonjugator', nav_new:'Neu', nav_adjectives:'Adjektive', nav_reference:'Referenz', nav_conjugation:'Konjugation', nav_forms:'Formen', nav_verbs:'Verben',
  ...
  zh: {
    nav_home:'首页', nav_kana:'假名', nav_learn:'学习', nav_group_learn:'学习', nav_group_vocab:'词汇', nav_group_practice:'练习', nav_counters:'量词', nav_dictionary:'词典', nav_deconjugator:'逆变位', nav_new:'新', nav_adjectives:'形容词', nav_reference:'语法参考', nav_conjugation:'动词变形', nav_forms:'形式', nav_verbs:'动词',
...
(function () {
  ...
  var EXTRA_LINKS = [
    ...
    { page: 'dictionary', key: 'nav_dictionary', href: '/dictionary', after: 'kana', isNew: true },
