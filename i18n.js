...
var I18N = {
  en: {
    ...
    kw_cm_rainbow_h:"One step along the spectrum per right answer in a row — orange first, purple at seven. A miss drops it to a red outline and the walk starts again.",
  ...
  de: {
    ...
    kw_cm_rainbow_h:"Pro richtiger Antwort in Folge ein Schritt durchs Spektrum — erst Orange, Violett bei sieben. Ein Fehler setzt es auf einen roten Rand zurück, und der Weg beginnt von vorn.",
  ...
  fr: {
    ...
    kw_cm_rainbow_h:"Un pas dans le spectre par bonne réponse d’affilée — orange d’abord, violet à sept. Une erreur ramène un contour rouge et la marche recommence.",
  ...
  zh: {
    ...
    kw_cm_rainbow_h:"每连续答对一次就沿光谱前进一步——先是橙色，七次时到紫色。答错一次会变成红色描边，重新开始。",
    kw_hear:"听读音",
  ...
  ja: {
    ...
    kw_cm_rainbow_h:"続けて正解するたびに色が一段ずつ進みます。最初はオレンジ、7回で紫。まちがえると赤い枠に戻り、やり直しです。",
    kw_hear:"読みを聞く",
