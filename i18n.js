...
var I18N = {
  en: {
    ...
    howto_wok_1:"<b>Every kanji is a stamp on the wall</b> — all 2,300 from the Kodansha Kanji Learner’s Course, in course order, 100 to a block. Pick a block on the strip; <b>Jump to where I left off</b> takes you to the first block you haven’t finished.",
    howto_wok_2:"<b>Three looks.</b> <span class=\"howto-sw is-new\"></span> blank = not met yet · <span class=\"howto-sw is-shaky\"></span> red outline = shaky (you missed it) · <span class=\"howto-sw is-solid\"></span> colour = solid. The chips <b>All · Shaky · Not started · Solid</b> filter the block.",
    howto_wok_3:"<b>Colours</b> chooses what a solid stamp’s colour means: <i>Mosaic</i> (a fixed colour per kanji), <i>Ink</i> (one colour of yours, deepening with your streak), or <i>Spectrum</i> (red to purple, one step per right answer in a row).",
    howto_wok_4:"<b>Tap a stamp</b> to open its card: keyword, on and kun readings, example words, how often you got it right and wrong, and a Listen button for the readings and each word.",
    howto_wok_5:"<b>On the card:</b> <b>Drill this one</b> sends it to the Kitchen, <b>Mark as solid</b> stamps it without drilling, <b>Look it up</b> opens the Dictionary. ← → step to the next kanji, Esc closes.",
    howto_wok_6:"<b>Search</b> finds a kanji by character, keyword or KLC number — “日”, “sun” or #330.",
    howto_wok_7:"<b>One at a time</b> flips through the same block as flashcards. <b>Drill</b> shows the drill buttons: the block’s shaky ones, the ones you haven’t started, the whole block, or every shaky kanji on the wall.",
    howto_wok_8:"<b>How stamps change:</b> a right answer in the Kitchen makes a new kanji solid at once. Miss one and it turns shaky; two right in a row win it back. Skips change nothing.",
    howto_wok_9:"Progress lives in this browser only — nothing to sign up for, nothing leaves your device.",
    howto_kit_1:"<b>Choose what to cook.</b> The menu on the right picks a range of 500 to draw from at random. Or come from the wall — a block, or just your shaky kanji — and you get it as <b>rounds of ten</b>, shown as pips in the score bar.",
    howto_kit_2:"<b>Two directions:</b> <i>Kanji → Keyword</i> shows the character and asks for its meaning; <i>Keyword → Kanji</i> shows the meaning and asks you to type the character (an IME, or paste).",
    howto_kit_3:"<b>Type it or Pick it.</b> Typing is stricter but sticks better; Pick it offers four choices. Spelling slips, plurals and bracketed hints in keywords are forgiven. Enter checks, Enter again moves on.",
    howto_kit_4:"<b>Hear the readings</b> on the card reads the on and kun readings aloud; after you answer, the answer panel has its own Listen button.",
    howto_kit_5:"<b>Skip</b> is free — the kanji is neither right nor wrong and comes round again. <b>Show me the answer</b> counts as a miss, so use it when you are stuck, not curious.",
    howto_kit_6:"<b>Score:</b> Right, Wrong, Streak, Best and Skipped are for this visit; <b>Reset Score</b> clears them and nothing else. What you missed this round is listed under the card, newest first, with a ×2 badge when it happened twice.",
    howto_kit_7:"<b>Katsu</b> can pop in after six misses in a row — it is off unless you turn it on in his gear menu. You can always open him yourself.",
    howto_kit_8:"<b>Back to the wall:</b> the <b>← 壁 Wall</b> chip at the left of the toolbar, any time. At the end of a round you also get <b>Back to the wall</b> and <b>Drill the … again</b> for whatever is still shaky.",
    howto_kit_9:"Every answer is stamped on <b>The WoK</b>: right once makes a fresh kanji solid, a miss turns it shaky, two right in a row win it back.",
  ...
  de: {
    ...
    howto_wok_title:"The WoK",
    howto_kit_title:"Kanji Kitchen",
    howto_wok_1:"<b>Jedes Kanji ist ein Stempel an der Wand</b> — alle 2.300 aus dem Kodansha Kanji Learner’s Course, in Kursreihenfolge, 100 pro Block. Wähle einen Block in der Leiste; <b>Jump to where I left off</b> springt zum ersten Block, den du noch nicht fertig hast.",
    howto_wok_2:"<b>Drei Zustände.</b> <span class=\"howto-sw is-new\"></span> leer = noch nicht gesehen · <span class=\"howto-sw is-shaky\"></span> roter Rand = wackelig (verfehlt) · <span class=\"howto-sw is-solid\"></span> Farbe = sicher. Die Chips <b>All · Shaky · Not started · Solid</b> filtern den Block.",
    howto_wok_3:"<b>Colours</b> legt fest, was die Farbe eines sicheren Stempels bedeutet: <i>Mosaic</i> (feste Farbe pro Kanji), <i>Ink</i> (eine Farbe deiner Wahl, die mit der Serie dunkler wird) oder <i>Spectrum</i> (Rot bis Violett, ein Schritt pro richtiger Antwort in Folge).",
    howto_wok_4:"<b>Tippe auf einen Stempel</b> und seine Karte öffnet sich: Stichwort, On- und Kun-Lesungen, Beispielwörter, wie oft du richtig und falsch lagst, und ein Anhören-Knopf für Lesungen und jedes Wort.",
    howto_wok_5:"<b>Auf der Karte:</b> <b>Drill this one</b> schickt es in die Kitchen, <b>Mark as solid</b> stempelt es ohne Üben, <b>Look it up</b> öffnet das Wörterbuch. ← → zum nächsten Kanji, Esc schließt.",
    howto_wok_6:"<b>Suche</b> findet ein Kanji per Zeichen, Stichwort oder KLC-Nummer — „日“, „sun“ oder #330.",
    howto_wok_7:"<b>One at a time</b> blättert denselben Block als Karteikarten durch. <b>Drill</b> zeigt die Übungsknöpfe: die wackeligen des Blocks, die noch nicht begonnenen, den ganzen Block oder alle wackeligen der Wand.",
    howto_wok_8:"<b>So ändern sich Stempel:</b> eine richtige Antwort in der Kitchen macht ein neues Kanji sofort sicher. Ein Fehler macht es wackelig; zweimal richtig in Folge holt es zurück. Überspringen ändert nichts.",
    howto_wok_9:"Der Fortschritt bleibt in diesem Browser — kein Konto, nichts verlässt dein Gerät.",
    howto_kit_1:"<b>Wähle, was gekocht wird.</b> Das Menü rechts nimmt einen 500er-Bereich, zufällig gemischt. Oder komm von der Wand — ein Block oder nur deine wackeligen — dann gibt es <b>Zehnerrunden</b>, als Punkte in der Punkteleiste.",
    howto_kit_2:"<b>Zwei Richtungen:</b> <i>Kanji → Keyword</i> zeigt das Zeichen und fragt die Bedeutung; <i>Keyword → Kanji</i> zeigt die Bedeutung und du tippst das Zeichen (IME oder Einfügen).",
    howto_kit_3:"<b>Type it oder Pick it.</b> Tippen ist strenger, bleibt aber besser hängen; Pick it bietet vier Antworten. Tippfehler, Plural und Klammerhinweise werden verziehen. Enter prüft, Enter nochmal geht weiter.",
    howto_kit_4:"<b>Hear the readings</b> auf der Karte liest On- und Kun-Lesungen vor; nach der Antwort hat das Antwortfeld einen eigenen Anhören-Knopf.",
    howto_kit_5:"<b>Skip</b> kostet nichts — weder richtig noch falsch, das Kanji kommt wieder. <b>Antwort zeigen</b> zählt als Fehler, also nur, wenn du feststeckst.",
    howto_kit_6:"<b>Punkte:</b> Richtig, Falsch, Serie, Bestwert und Übersprungen gelten für diesen Besuch; <b>Reset Score</b> löscht nur diese. Was du diese Runde verfehlt hast, steht unter der Karte, neuestes zuerst, mit ×2, wenn es zweimal war.",
    howto_kit_7:"<b>Katsu</b> kann nach sechs Fehlern in Folge auftauchen — das ist aus, bis du es in seinem Zahnrad einschaltest. Öffnen kannst du ihn jederzeit selbst.",
    howto_kit_8:"<b>Zurück zur Wand:</b> der Chip <b>← 壁 Wand</b> links in der Leiste, jederzeit. Am Ende einer Runde gibt es außerdem <b>Zurück zur Wand</b> und <b>… noch einmal üben</b> für alles, was noch wackelig ist.",
    howto_kit_9:"Jede Antwort wird an <b>The WoK</b> gestempelt: einmal richtig macht ein neues Kanji sicher, ein Fehler macht es wackelig, zweimal richtig holt es zurück.",
  ...
  fr: {
    ...
    howto_wok_title:"The WoK",
    howto_kit_title:"Kanji Kitchen",
    howto_wok_1:"<b>Chaque kanji est un tampon sur le mur</b> — les 2 300 du Kodansha Kanji Learner’s Course, dans l’ordre du cours, 100 par bloc. Choisis un bloc dans la bande ; <b>Jump to where I left off</b> t’amène au premier bloc pas encore fini.",
    howto_wok_2:"<b>Trois aspects.</b> <span class=\"howto-sw is-new\"></span> vide = pas encore vu · <span class=\"howto-sw is-shaky\"></span> contour rouge = fragile (raté) · <span class=\"howto-sw is-solid\"></span> couleur = acquis. Les puces <b>All · Shaky · Not started · Solid</b> filtrent le bloc.",
    howto_wok_3:"<b>Colours</b> choisit ce que signifie la couleur d’un tampon acquis : <i>Mosaic</i> (une couleur fixe par kanji), <i>Ink</i> (une couleur à toi, qui fonce avec ta série) ou <i>Spectrum</i> (du rouge au violet, un pas par bonne réponse d’affilée).",
    howto_wok_4:"<b>Touche un tampon</b> pour ouvrir sa fiche : mot-clé, lectures on et kun, mots d’exemple, tes bonnes et mauvaises réponses, et un bouton Écouter pour les lectures et chaque mot.",
    howto_wok_5:"<b>Sur la fiche :</b> <b>Drill this one</b> l’envoie à la Kitchen, <b>Mark as solid</b> le tamponne sans exercice, <b>Look it up</b> ouvre le Dictionnaire. ← → passe au kanji suivant, Échap ferme.",
    howto_wok_6:"<b>Rechercher</b> trouve un kanji par caractère, mot-clé ou numéro KLC — « 日 », « sun » ou #330.",
    howto_wok_7:"<b>One at a time</b> fait défiler le même bloc en cartes. <b>Drill</b> affiche les boutons d’exercice : les fragiles du bloc, ceux pas commencés, tout le bloc, ou tous les fragiles du mur.",
    howto_wok_8:"<b>Comment les tampons changent :</b> une bonne réponse dans la Kitchen rend un nouveau kanji acquis d’emblée. Rate-le et il devient fragile ; deux bonnes réponses d’affilée le rattrapent. Passer ne change rien.",
    howto_wok_9:"Ta progression reste dans ce navigateur — pas de compte, rien ne quitte ton appareil.",
    howto_kit_1:"<b>Choisis quoi cuisiner.</b> Le menu à droite prend une tranche de 500, au hasard. Ou viens du mur — un bloc, ou seulement tes fragiles — et tu as des <b>manches de dix</b>, en points dans la barre de score.",
    howto_kit_2:"<b>Deux sens :</b> <i>Kanji → Keyword</i> montre le caractère et demande le sens ; <i>Keyword → Kanji</i> montre le sens et tu tapes le caractère (IME ou coller).",
    howto_kit_3:"<b>Type it ou Pick it.</b> Taper est plus strict mais s’ancre mieux ; Pick it propose quatre choix. Fautes de frappe, pluriels et indices entre crochets sont pardonnés. Entrée vérifie, Entrée encore passe au suivant.",
    howto_kit_4:"<b>Hear the readings</b> sur la carte lit les lectures on et kun ; après ta réponse, le panneau de réponse a son propre bouton Écouter.",
    howto_kit_5:"<b>Skip</b> est gratuit — ni juste ni faux, le kanji reviendra. <b>Voir la réponse</b> compte comme une erreur : quand tu bloques, pas par curiosité.",
    howto_kit_6:"<b>Score :</b> Justes, Fausses, Série, Record et Passées valent pour cette visite ; <b>Reset Score</b> n’efface que ça. Ce que tu as raté cette manche s’affiche sous la carte, le plus récent en premier, avec ×2 si c’est arrivé deux fois.",
    howto_kit_7:"<b>Katsu</b> peut apparaître après six erreurs d’affilée — c’est désactivé tant que tu ne l’actives pas dans son engrenage. Tu peux toujours l’ouvrir toi-même.",
    howto_kit_8:"<b>Retour au mur :</b> la puce <b>← 壁 Mur</b> à gauche de la barre, à tout moment. En fin de manche tu as aussi <b>Retour au mur</b> et <b>Retravailler les … encore</b> pour ce qui reste fragile.",
    howto_kit_9:"Chaque réponse est tamponnée sur <b>The WoK</b> : une bonne réponse rend un nouveau kanji acquis, une erreur le rend fragile, deux bonnes d’affilée le rattrapent.",
  ...
  zh: {
    ...
    howto_wok_title:"The WoK",
    howto_kit_title:"Kanji Kitchen",
    howto_wok_1:"<b>每个汉字都是墙上的一枚印章</b>——讲谈社《Kanji Learner’s Course》全部 2,300 字，按课程顺序，每 100 字一组。在横条上选一组；<b>Jump to where I left off</b> 跳到你还没完成的第一组。",
    howto_wok_2:"<b>三种状态。</b><span class=\"howto-sw is-new\"></span> 空白 = 还没见过 · <span class=\"howto-sw is-shaky\"></span> 红框 = 不稳（答错过）· <span class=\"howto-sw is-solid\"></span> 有色 = 掌握。<b>All · Shaky · Not started · Solid</b> 筛选这一组。",
    howto_wok_3:"<b>Colours</b> 决定掌握印章的颜色含义：<i>Mosaic</i>（每字一个固定颜色）、<i>Ink</i>（你选的一种颜色，随连对加深）或 <i>Spectrum</i>（从红到紫，每连对一次进一步）。",
    howto_wok_4:"<b>点一枚印章</b>打开它的卡片：关键词、音读与训读、例词、你答对答错的次数，以及朗读读音和每个例词的按钮。",
    howto_wok_5:"<b>卡片上：</b><b>Drill this one</b> 送进 Kitchen，<b>Mark as solid</b> 不练直接盖章，<b>Look it up</b> 打开词典。← → 切换到相邻汉字，Esc 关闭。",
    howto_wok_6:"<b>搜索</b>可按字、关键词或 KLC 编号查找——“日”、“sun”或 #330。",
    howto_wok_7:"<b>One at a time</b> 把同一组按单词卡逐个翻看。<b>Drill</b> 显示练习按钮：本组不稳的、还没开始的、整组，或全墙所有不稳的字。",
    howto_wok_8:"<b>印章怎么变：</b>在 Kitchen 答对一次，新字立刻掌握；答错一次变不稳，连对两次夺回。跳过不改变任何东西。",
    howto_wok_9:"进度只保存在这个浏览器里——无需注册，数据不会离开你的设备。",
    howto_kit_1:"<b>选择要练的内容。</b>右侧菜单从 500 字的范围里随机抽取。或者从墙上带来一组、或只带不稳的字，那就是<b>每轮十题</b>，在计分栏显示为小点。",
    howto_kit_2:"<b>两个方向：</b><i>Kanji → Keyword</i> 显示汉字问含义；<i>Keyword → Kanji</i> 显示含义让你输入汉字（输入法或粘贴）。",
    howto_kit_3:"<b>Type it 或 Pick it。</b>打字更严格但记得更牢；Pick it 给四个选项。拼写小错、复数和括号里的提示都会被宽容。回车检查，再按回车下一题。",
    howto_kit_4:"卡片上的 <b>Hear the readings</b> 朗读音读和训读；作答后，答案面板有自己的朗读按钮。",
    howto_kit_5:"<b>Skip</b> 不计分——不算对也不算错，之后还会再出现。<b>查看答案</b>算答错，卡住时再用。",
    howto_kit_6:"<b>计分：</b>正确、错误、连对、最佳和跳过只算本次访问；<b>Reset Score</b> 只清这些。本轮答错的字列在卡片下方，最新在前，错两次会有 ×2 标记。",
    howto_kit_7:"连续答错六题后 <b>Katsu</b> 可以出来帮忙——默认关闭，需在他的齿轮菜单里打开。你随时可以自己点开他。",
    howto_kit_8:"<b>返回字墙：</b>工具栏左侧的 <b>← 壁 字墙</b> 按钮，随时可用。一轮结束时还会有<b>返回字墙</b>和<b>再练一遍</b>（针对仍不稳的字）。",
    howto_kit_9:"每次作答都会盖在 <b>The WoK</b> 上：新字答对一次即掌握，答错一次变不稳，连对两次夺回。",
  ...
  ja: {
    ...
    howto_wok_title:"The WoK",
    howto_kit_title:"Kanji Kitchen",
    howto_wok_1:"<b>漢字は一字ずつ壁のスタンプ</b> — 講談社 Kanji Learner’s Course の2,300字を、コース順に100字ずつ。帯からブロックを選びます。<b>Jump to where I left off</b> は、まだ終えていない最初のブロックへ。",
    howto_wok_2:"<b>三つの見た目。</b><span class=\"howto-sw is-new\"></span> 白 = まだ見ていない · <span class=\"howto-sw is-shaky\"></span> 赤枠 = 不安定（間違えた）· <span class=\"howto-sw is-solid\"></span> 色つき = 定着。<b>All · Shaky · Not started · Solid</b> でブロックを絞れます。",
    howto_wok_3:"<b>Colours</b> は定着スタンプの色の意味を決めます：<i>Mosaic</i>（字ごとに固定の色）、<i>Ink</i>（好きな一色が連続正解で濃くなる）、<i>Spectrum</i>（赤から紫へ、連続正解ごとに一段）。",
    howto_wok_4:"<b>スタンプをタップ</b>するとカードが開きます：キーワード、音読み・訓読み、例語、正解・不正解の回数、読みと各語の聞くボタン。",
    howto_wok_5:"<b>カードでは：</b><b>Drill this one</b> で Kitchen へ、<b>Mark as solid</b> で練習なしに定着、<b>Look it up</b> で辞書へ。← → で隣の字、Esc で閉じます。",
    howto_wok_6:"<b>検索</b>は字・キーワード・KLC番号で探せます — 「日」「sun」「#330」。",
    howto_wok_7:"<b>One at a time</b> は同じブロックを単語カードのようにめくります。<b>Drill</b> で練習ボタンが出ます：ブロックの不安定な字、未着手の字、ブロック全部、壁の不安定な字すべて。",
    howto_wok_8:"<b>スタンプの変わり方：</b>Kitchen で一度正解すれば新しい字はすぐ定着。間違えると不安定、二連続正解で回復。スキップは何も変えません。",
    howto_wok_9:"進み具合はこのブラウザにだけ保存されます。登録不要、データは端末の外に出ません。",
    howto_kit_1:"<b>何を練習するか選ぶ。</b>右のメニューで500字の範囲からランダムに出題。壁から来た場合 — ブロック、または不安定な字だけ — は<b>10問ずつ</b>で、スコア欄に点で表示されます。",
    howto_kit_2:"<b>二つの方向：</b><i>Kanji → Keyword</i> は字を見て意味を答える。<i>Keyword → Kanji</i> は意味を見て字を入力（IMEか貼り付け）。",
    howto_kit_3:"<b>Type it か Pick it。</b>入力は厳しめですがよく身につきます。Pick it は四択。綴りの揺れ、複数形、括弧内のヒントは大目に見ます。Enter で確認、もう一度 Enter で次へ。",
    howto_kit_4:"カードの <b>Hear the readings</b> で音読み・訓読みを読み上げ。答えたあとは答えの欄にも聞くボタンがあります。",
    howto_kit_5:"<b>Skip</b> は無料 — 正解でも不正解でもなく、また出てきます。<b>答えを見る</b>は不正解扱い、行き詰まったときだけ。",
    howto_kit_6:"<b>スコア：</b>正解・不正解・連続・最高・スキップは今回の分。<b>Reset Score</b> はそれだけを消します。このラウンドの間違いはカードの下に新しい順、二度なら ×2。",
    howto_kit_7:"六連続で間違えると <b>Katsu</b> が来られます — 歯車で入れるまでオフです。自分で開くのはいつでも。",
    howto_kit_8:"<b>壁に戻る：</b>ツールバー左端の <b>← 壁 戻る</b> でいつでも。ラウンドの終わりには<b>壁に戻る</b>と、まだ不安定な字を<b>もう一度</b>練習するボタンも出ます。",
    howto_kit_9:"答えはすべて <b>The WoK</b> に押されます：新しい字は一度の正解で定着、一度の間違いで不安定、二連続正解で回復。",
