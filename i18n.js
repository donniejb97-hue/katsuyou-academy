...
var I18N = {
  en: {
    ...
    howto_shift_2:"<b>Pick what to practise:</b> <b>Meaning</b> (what does it mean?), <b>Reading</b> (how is it read?) and <b>Say it in Japanese</b>. Switch on one, two or all three.",
    howto_shift_3:"<b>Filters</b> narrow the quiz to topics and levels. Leave them alone and it mixes everything, bringing back what you’ve missed more often.",
  ...
  de: {
    ...
    howto_shift_2:"<b>Wähle, was du üben willst:</b> <b>Bedeutung</b> (was heißt das?), <b>Lesung</b> (wie liest man das?) und <b>Sag es auf Japanisch</b>. Schalte eins, zwei oder alle drei ein.",
    howto_shift_3:"<b>Filter</b> grenzen das Quiz auf Themen und Stufen ein. Lässt du sie in Ruhe, mischt es alles und bringt häufiger zurück, was du nicht wusstest.",
  ...
  fr: {
    ...
    howto_shift_2:"<b>Choisissez quoi travailler :</b> <b>Sens</b> (que veut-il dire ?), <b>Lecture</b> (comment se lit-il ?) et <b>Dites-le en japonais</b>. Activez-en un, deux ou les trois.",
    howto_shift_3:"<b>Les filtres</b> limitent le quiz à des thèmes et des niveaux. Sans rien changer, il mélange tout et revient plus souvent sur vos erreurs.",
  ...
  zh: {
    ...
    howto_shift_2:"<b>选择练习内容：</b><b>意思</b>（是什么意思？）、<b>读音</b>（怎么读？）和<b>用日语说</b>。可以开一项、两项或全部三项。",
    howto_shift_3:"<b>筛选</b>可以把测验限定在某些主题和级别。保持原样的话，测验会混合出题，并更常出现你答错的词。",
  ...
  ja: {
    ...
    howto_shift_2:"<b>練習する内容を選ぶ：</b><b>意味</b>（どういう意味？）、<b>読み</b>（どう読む？）、<b>日本語で言う</b>。ひとつ、ふたつ、または三つ全部オンにできます。",
    howto_shift_3:"<b>絞り込み</b>でテーマやレベルを選べます。そのままにしておくと全部を混ぜて出題し、間違えた単語をよく出します。",
