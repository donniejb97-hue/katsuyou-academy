...
var I18N = {
  en: {
    ...
    howto_tv_6:"<b>◀◀ Rewind your misses</b> sends the verbs you got wrong to Rewind, where you take them apart backwards. Misses also come back here by themselves.",
    howto_vhs_1:"<b>Start here:</b> the tape shows a conjugated verb. Type the dictionary form it came from — taberu turns into たべる — and press <b>◀◀ Rewind</b> or Enter.",
    ...
    howto_vhs_6:"<b>▶ Practise your misses in 活用 TV</b> sends the verbs you missed to 活用 TV, where you build them forwards.",
    ...
    tv_send_rew:"◀◀ Rewind your misses ({n})",
    tv_tape:"tape",
    ...
    vhs_send_tv:"▶ Practise your misses in 活用 TV ({n})",
  ...
  de: {
    ...
    howto_tv_6:"<b>◀◀ Fehler in Rewind</b> schickt deine falschen Verben zu Rewind, wo du sie rückwärts zerlegst. Fehler kommen auch hier von selbst wieder.",
    howto_vhs_1:"<b>So fängst du an:</b> Auf dem Band ist ein konjugiertes Verb. Tipp die Wörterbuchform, aus der es kommt — taberu wird zu たべる — und drück <b>◀◀ Zurückspulen</b> oder Enter.",
    ...
    howto_vhs_6:"<b>▶ Fehler in 活用 TV üben</b> schickt deine falschen Verben zu 活用 TV, wo du sie vorwärts bildest.",
    ...
    tv_sum_type:"Verbart",
    tv_send_rew:"◀◀ Fehler in Rewind ({n})",
    tv_tape:"Band",
    ...
    vhs_send_tv:"▶ Fehler in 活用 TV üben ({n})",
  ...
  fr: {
    ...
    howto_tv_6:"<b>◀◀ Rembobiner vos erreurs</b> envoie les verbes manqués à Rewind, où vous les décomposez à l’envers. Les erreurs reviennent aussi ici d’elles-mêmes.",
    howto_vhs_1:"<b>Pour commencer :</b> la cassette montre un verbe conjugué. Tapez la forme du dictionnaire d’où il vient — taberu devient たべる — puis appuyez sur <b>◀◀ Rembobiner</b> ou Entrée.",
    ...
    howto_vhs_6:"<b>▶ Travailler vos erreurs dans 活用 TV</b> envoie les verbes manqués à 活用 TV, où vous les construisez à l’endroit.",
    ...
    tv_send_rew:"◀◀ Rembobiner vos erreurs ({n})",
    tv_tape:"cassette",
    ...
    vhs_send_tv:"▶ Travailler vos erreurs dans 活用 TV ({n})",
  ...
  zh: {
    ...
    howto_tv_6:"<b>◀◀ 在 Rewind 倒带答错的</b>会把你答错的动词送到 Rewind，在那里倒着拆开。答错的也会自己回到这里。",
    howto_vhs_1:"<b>从这里开始：</b>录像带上是一个变形后的动词。输入它的辞书形——taberu 会变成 たべる——然后按 <b>◀◀ 倒带</b> 或 Enter。",
    ...
    howto_vhs_6:"<b>▶ 在 活用 TV 练答错的</b>会把你答错的动词送到 活用 TV，在那里正着变形。",
    tv_eyebrow:"动词变形练习",
    tv_onair:"直播中",
    tv_to_rewind:"Rewind",
    tv_end:"本集结束",
  ...
  ja: {
    ...
    howto_tv_6:"<b>◀◀ 間違いを Rewind で</b>を押すと、間違えた動詞が Rewind に送られ、逆から分解できます。間違いはここにも自然に戻ってきます。",
    howto_vhs_1:"<b>まずはここから：</b>テープに活用した動詞。元の辞書形を入力——taberu が たべる に——して <b>◀◀ 巻き戻す</b> か Enter。",
    ...
    howto_vhs_6:"<b>▶ 間違いを 活用 TV で練習</b>を押すと、間違えた動詞が 活用 TV に送られ、前から活用できます。",
    tv_eyebrow:"活用の練習",
    tv_onair:"放送中",
    tv_to_rewind:"Rewind",
    tv_end:"本日の放送終了",
